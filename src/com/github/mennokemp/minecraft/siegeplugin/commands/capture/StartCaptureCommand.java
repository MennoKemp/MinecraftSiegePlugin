...
public class StartCaptureCommand extends Command
{
	...
	public StartCaptureCommand(IGameStateService gameStateService, ICaptureService captureService)
	{
	...
	{
		return captureService.startCapture(CapturePoint.valueOf(args[0]));
	}
}